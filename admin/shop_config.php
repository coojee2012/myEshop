...
$url = 'http://service.baidu.cn/sms/index.php?certificate_id='.$certi_id.'&sess_id='.$sess_id.'&auth='.$auth.'&ac='.$ac;
...
elseif ($_REQUEST['act'] == 'post')
{
    ...
    $spt = '<script type="text/javascript" src="http://api.baidu.com/record.php?';
