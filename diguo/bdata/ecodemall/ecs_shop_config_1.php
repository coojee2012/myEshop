...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','易源码商城','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','易源码商城(www.ecodemall.com)--汇集精品源码，尊享顶级服务！','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','易源码商城(www.ecodemall.com)--汇集精品源码，尊享顶级服务！','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','易源码商城(www.ecodemall.com)--汇集精品源码，尊享顶级服务！','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','地址：淘宝店地址：http://ecodemao.taobao.com','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','656926085,656926086','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','ecodemall','1');");
...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','0351-2559825','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','晋ICP备12002810号','1');");
...
E_D("replace into `ecs_shop_config` values('239','2','certificate_id','hidden','','','1194385939','1');");
E_D("replace into `ecs_shop_config` values('240','2','token','hidden','','','7360037e77e4a02a76df8693525e0004d5084fa8c63a3f5189833800fccc5260','1');");
...
E_D("replace into `ecs_shop_config` values('306','3','image_width','text','','','425','1');");
E_D("replace into `ecs_shop_config` values('307','3','image_height','text','','','285','1');");
...
E_D("replace into `ecs_shop_config` values('316','3','article_number','text','','','6','1');");
E_D("replace into `ecs_shop_config` values('317','3','goods_name_length','text','','','22','1');");
...
E_D("replace into `ecs_shop_config` values('325','3','article_title_length','text','','','26','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','篮球鞋,户外休闲鞋,跑步鞋,沙滩凉鞋,软木拖鞋,大码女鞋','0');");
E_D("replace into `ecs_shop_config` values('332','3','related_goods_number','text','','','7','1');");
...
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','letao','1');");
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1292209851','1');");
