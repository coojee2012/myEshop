...
E_D("replace into `ecs_article_cat` values('15','小脚丫','1','','','50','0','0');");
E_D("replace into `ecs_article_cat` values('7','配送与支付 ','5','','配送与支付 ','50','0','3');");
E_D("replace into `ecs_article_cat` values('14','公告','1','','','50','0','0');");
...
E_D("replace into `ecs_article_cat` values('12','最新资讯','1','','','50','0','0');");
