...
<title>童鞋_本源码由莎莎源码论坛[bbs.sasadown.cn]提供下载! - Powered by ECShop</title>
...
<div class="block clearfix">
  ...
  <a  class="a1 "  href="category.php?id=254" >户外</a>
   ...
   <ul class="u1" onmouseover="this.className='u1 u1_over'" onmouseout="this.className='u1'" >
  <a  class="a1  cur "  href="category.php?id=194" >童鞋</a>
  </ul>
...
<div class="block950 clearfix"> 
     ...
     <div class="tit">属性筛选</div>
              ...
              <ul>
														<span>全部</span>
																			<a href="category.php?id=194&amp;brand=32&amp;price_min=0&amp;price_max=0">SALO</a>
									                </ul>
			</div>
...
<div class="blank"></div>
 ...
 排序：
  <a href="category.php?category=194&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/letao/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=194&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/letao/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=194&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/letao/images/last_update_default.gif" alt="按更新时间排序"></a>
</div>
  ...
  <input type="hidden" name="order" value="DESC" />
      ...
      <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
           ...
           <a href="goods.php?id=98"><img src="images/201206/thumb_img/98_thumb_G_1339236279871.jpg" alt="易源码商城 ecodemall.com测试商..." class="goodsimg" /></a> 
           ...
           <a href="goods.php?id=97"><img src="images/201206/thumb_img/97_thumb_G_1339236279236.jpg" alt="易源码商城 ecodemall.com测试商..." class="goodsimg" /></a> 
           <p class="name"><a href="goods.php?id=97" title="易源码商城 ecodemall.com测试商品26">易源码商城 ecodemall.com测试商...</a></p>
                 ...
                 <div class="goodsItem goodsItem2"                    >
           <a href="goods.php?id=96"><img src="images/201206/thumb_img/96_thumb_G_1339236278370.jpg" alt="易源码商城 ecodemall.com测试商..." class="goodsimg" /></a> 
           <p class="name"><a href="goods.php?id=96" title="易源码商城 ecodemall.com测试商品25">易源码商城 ecodemall.com测试商...</a></p>
                 ...
                 <div class="goodsItem goodsItem2"                    >
           <a href="goods.php?id=95"><img src="images/201206/thumb_img/95_thumb_G_1339236278010.jpg" alt="易源码商城 ecodemall.com测试商..." class="goodsimg" /></a> 
           <p class="name"><a href="goods.php?id=95" title="易源码商城 ecodemall.com测试商品24">易源码商城 ecodemall.com测试商...</a></p>
                 ...
                 <div class="goodsItem goodsItem2"                    >
           <a href="goods.php?id=94"><img src="images/201206/thumb_img/94_thumb_G_1339236280072.jpg" alt="易源码商城 ecodemall.com测试商..." class="goodsimg" /></a> 
