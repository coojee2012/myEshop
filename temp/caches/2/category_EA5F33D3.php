...
<title>梦特娇_女鞋_本源码由莎莎源码论坛[bbs.sasadown.cn]提供下载! - Powered by ECShop</title>
...
<div class="blank"></div>
 ...
 排序：
  <a href="category.php?category=159&display=grid&brand=34&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/letao/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=159&display=grid&brand=34&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/letao/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=159&display=grid&brand=34&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/letao/images/last_update_default.gif" alt="按更新时间排序"></a>
</div>
  ...
  <input type="hidden" name="order" value="DESC" />
      ...
      <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
           ...
           <a href="goods.php?id=76"><img src="images/201206/thumb_img/76_thumb_G_1339236287644.jpg" alt="易源码商城 ecodemall.com测试商..." class="goodsimg" /></a> 
