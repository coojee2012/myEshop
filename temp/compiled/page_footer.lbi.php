<div class="block tc" style="">
  <img src="themes/jd/images/fot_img0.gif">
</div>
<div class="block tc" style="margin-bottom:20px;">
   <?php if ($this->_var['navigator_list']['bottom']): ?>
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_47655700_1419685117');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_47655700_1419685117']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_47655700_1419685117']['url']; ?>" <?php if ($this->_var['nav_0_47655700_1419685117']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_47655700_1419685117']['name']; ?></a> 
...
?>
      ...
      <?php endif; ?>   <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?><a href="http://www.baidu.com" style="display:none;">68ECSHOP模版中心</a><?php $_from = $this->_var['ww']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'im');if (count($_from)):
    foreach ($_from AS $this->_var['im']):
...
?>
      <?php if ($this->_var['im']): ?>
      <a href="http://edit.yahoo.com/config/send_webmesg?.target=<?php echo $this->_var['im']; ?>n&.src=pg" target="_blank"><img src="themes/jd/images/yahoo.gif" width="18" height="17" border="0" alt="Yahoo Messenger" /> <?php echo $this->_var['im']; ?></a>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
      <?php if ($this->_var['im']): ?>
      <img src="themes/jd/images/msn.gif" width="18" height="17" border="0" alt="MSN" /> <a href="msnim:chat?contact=<?php echo $this->_var['im']; ?>"><?php echo $this->_var['im']; ?></a>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?><br />
  ...
  <br />
    ...
    <?php endif; ?>
    <a href="http://www.baidu.com">诚和办公©版权所有</a>
