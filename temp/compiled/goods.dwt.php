...
<script type="text/javascript" src="themes/jd/js/mzp-packed-me.js"></script>
...
?>
			...
			<span><?php echo $this->_var['lang']['goods_sn']; ?><?php echo $this->_var['goods']['goods_sn']; ?>
			</span><?php endif; ?>
			
            
			<?php if ($this->_var['goods']['goods_number'] != "" && $this->_var['cfg']['show_goodsnumber']): ?>
			<span><?php if ($this->_var['goods']['goods_number'] == 0): ?>
			<?php echo $this->_var['lang']['goods_number']; ?><img src="themes/jd/images/wuhuo.gif" />
			<?php else: ?>
			...
			<?php if ($this->_var['goods']['goods_brand'] != "" && $this->_var['cfg']['show_brand']): ?>
			  <span><?php echo $this->_var['lang']['goods_brand']; ?><a href="<?php echo $this->_var['goods']['goods_brand_url']; ?>" ><u><?php echo $this->_var['goods']['goods_brand']; ?></u></a>
			</span><?php endif; ?>
			
            
			<?php if ($this->_var['cfg']['show_goodsweight']): ?>
			<span><?php echo $this->_var['lang']['goods_weight']; ?><?php echo $this->_var['goods']['goods_weight']; ?>
			</span><?php endif; ?>
			
            
			<?php if ($this->_var['cfg']['show_addtime']): ?>
			<span><?php echo $this->_var['lang']['add_time']; ?><?php echo $this->_var['goods']['add_time']; ?>
			</span><?php endif; ?>
            ...
            <span>
			<?php echo $this->_var['lang']['goods_rank']; ?> <img src="themes/jd/images/stars<?php echo $this->_var['goods']['comment_rank']; ?>.gif" alt="comment rank <?php echo $this->_var['goods']['comment_rank']; ?>" />
            </span>
			</p>
...
?>
		  ...
		  <?php endif; ?>
			...
			<a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/jd/images/bnt_buy.gif" /></a> 
...
?>
        <tr>
          <th colspan="2" bgcolor="#FFFFFF"><?php echo htmlspecialchars($this->_var['key']); ?>sadss</th>
        </tr>
